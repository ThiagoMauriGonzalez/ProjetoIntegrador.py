...
def loop_tabela(): # função do loop 
    continuar_loop= input("Deseja Continuar? S/N ")
    
    if continuar_loop == "s" or continuar_loop == "S":
        tabela() #chamando a função da tabela para repetir o código após o usuário digitar S ou s
    elif continuar_loop == "n" or continuar_loop == "N":
        print ("PROGRAMA FINALIZADO")
    else:
        print("Coloque uma opção válida!")  
        loop_tabela() #retornando a função do loop

tabela() #chamando função a tabela para rodar o código pela  primeira vez
loop_tabela() #chamando a função do loop para rodar pela primeira vez
